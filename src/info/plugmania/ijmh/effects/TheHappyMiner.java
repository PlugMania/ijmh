...
public class TheHappyMiner {
	...
	public void command(CommandSender sender, String[] args) {
		...
		if(args.length==1) {
			...
			c.put(1, plugin.util.cRow("message", "tired", "boolean", "true", "true/false"));
			c.put(2, plugin.util.cRow("chance", "tired", "integer", "5", "1-100"));
			c.put(3, plugin.util.cRow("chancemod", "tired", "integer", "1", "1-?"));
			c.put(4, plugin.util.cRow("multiplier", "tired", "integer", "1", "1-5"));
			c.put(5, plugin.util.cRow("duration", "tired", "integer", "10", "1-? seconds"));
			c.put(6, plugin.util.cRow("multiplier", "hunger", "integer", "1", null));
			c.put(7, plugin.util.cRow("duration", "hunger", "integer", "10", null));
			c.put(8, plugin.util.cRow("message", "energized", "boolean", "true", null));
			c.put(9, plugin.util.cRow("chance", "energized", "integer", "5", null));
			c.put(10, plugin.util.cRow("chancemod", "energized", "integer", "1", null));
			c.put(11, plugin.util.cRow("multiplier", "energized", "integer", "1", null));
			c.put(12, plugin.util.cRow("duration", "energized", "integer", "10", null));
